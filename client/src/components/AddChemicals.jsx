...
const AddChemicals= () => {
    ...
    const chemicalOptions = [
        'AddCDE', 'AddCMC', 'AddCaustic', 'AddChlorine', 'AddColor', 'AddDOD', 'AddFinesalt', 
        'AddGlycerine', 'AddHCL', 'AddIndustrialSalt', 'AddMagadi', 'AddNP9', 'AddPINE', 
        'AddPearlizer', 'AddPearls', 'AddPerfume', 'AddUfacid', 'AddUndilutedKerrol', 'AddUngeral','AddTolietballs','AddDowny'
      ];
